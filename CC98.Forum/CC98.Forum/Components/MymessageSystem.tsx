...
import { MymessageSystemwindow } from './MymessageSystemwindow';

/**
 * 我的私信，包括最近联系人列表和聊天窗口两个组件
 */
export class MymessageSystem extends React.Component<{}, MymessageMessageState> {
    ...
    render() {
        ...
        return (
            <div className='mymessage-system'>
                <MymessageSystemwindow chatName={this.state.chatName} chatPortraitUrl={this.state.chatPortraitUrl} myName={this.state.myName} myPortraitUrl={this.state.myPortraitUrl} token={this.state.token} />
            </div>
        );
    }
}

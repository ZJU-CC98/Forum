        ...
        return (<div className="message-response-box">
            <div className="message-response-box-middle">
                ...
                <div className="message-response-box-middle-content">
                    <UbbContainer code={content} options={{ allowExternalImage: false, allowAutoPlay: false, autoDetectUrl: true, allowExternalUrl: true, allowImage: false, allowMediaContent: false, compatibility: UbbCompatiblityMode.Recommended, allowEmotion: false }} />
                </div>
            </div>
        </div>
        );

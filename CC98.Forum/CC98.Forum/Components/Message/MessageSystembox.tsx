...
export class MessageSystembox extends React.Component<MessageSystemProps> {
    ...
    render() {
        ...
        return (<div className="message-system-box">
                ...
                <UbbContainer code={content} options={{ allowAutoPlay: false, autoDetectUrl: true, allowExternalUrl: true, allowImage: true, allowMediaContent: false, compatibility: UbbCompatiblityMode.Recommended, allowEmotion: false }}/>
                    </div>
                </div>);
    }
}
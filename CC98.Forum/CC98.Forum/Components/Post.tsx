	...
	render() {
		return <div className="root">
			<div className="essay">
				...
				<div id="ads"><img src={this.props.imgUrl} /></div>
			</div>
...
export class TopicContent extends RouteComponent<{ content: string, signature: string }, { likeNumber, dislikeNumber }, {}> {
	constructor(props, content) {
		super(props, content);
		this.state = {
			likeNumber: 666,
...
export class TopicGood extends RouteComponent<{}, State.TopicGoodState, {}> {
	...
	render() {
		return <div className="good tagSize" style={{ marginLeft: '2px' }}>
			<div id="userImage"><img src={this.state.imgUrl} /> </div>

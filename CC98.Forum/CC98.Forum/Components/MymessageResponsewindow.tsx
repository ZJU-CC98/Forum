...
export class MymessageResponsewindow extends React.Component<MymessageWindowProps, MymessageWindowState>{
    ...
    render() {
        ...
        return (
            <div className='mymessage-response-box'>{this.state.data.map(this.coverMymessageProps)}</div>
        );
    }
}

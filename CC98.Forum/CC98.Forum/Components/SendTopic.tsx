...
export class SendTopic extends RouteComponent<{ topicid, onChange }, { content: string }, {}>{
    ...
    render() {
        ...
        return <div style={{ width: "100%", display: "flex", flexDirection: "column" }}><div id="sendTopic">
            <form>
                <div id="test-editormd" className="form-control">
                    <textarea className="editormd-markdown-textarea" name="test-editormd-markdown-doc" value={this.state.content} onChange={this.handleChange.bind(this)} ></textarea>
                <textarea id="test-editormd-html-code" name="test-editormd-html-code" style={{ display: "none" }} >
                </textarea>
                </div>   
                </form>

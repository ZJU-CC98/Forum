...
const themeList = ['系统默认', '冬季', '春季（浅色）', '春季（深色）', '夏季', '秋季（橙色）', '秋季（红色）', '双十一', '中秋（暗）','中秋（亮）'];
    ...
    return (
      <div className="user-theme">
        ...
        <div className="user-theme-config">
          <button style={{ backgroundColor: 'rgb(52,150,159)' }} key={0} onClick={() => this.handleSubmit(0)} disabled={this.props.userInfo.theme === 0}>系统默认</button>

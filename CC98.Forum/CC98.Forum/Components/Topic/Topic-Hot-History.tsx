...
export class Category extends React.Component {
    ...
    render() {
        return <div className="row" style={{ alignItems: "baseline", justifyContent: "flex-start", color: "grey", fontSize: "0.75rem", marginBottom: "1rem" }}>
            ...
            <div style={{ color: "grey", fontSize: "1rem", marginLeft: "0.5rem", marginRight: "0.5rem" }}>历史上的今天</div>
        </div>;
    }
}
 ...
 * 历史上的今天
 */
export class HistoryHotTopic extends React.Component<{}, FocusTopicAreaState> {
    ...
    async componentDidMount() {
        ...
        let data = await Utility.getMonthlyHotTopic("history");
        this.setState({
            data: data,
        });
    }
    ...
    render() {
        return (<div className="focus-root">
            <DocumentTitle title={`历史上的今天 - CC98论坛`} />
            <div className="focus" >
                <Category />

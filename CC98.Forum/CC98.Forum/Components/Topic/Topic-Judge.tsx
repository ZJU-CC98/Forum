...
export class Judge extends React.Component<Props, { reason; tips; UI }> {
  ...
  async confirm() {
    ...
    console.log($(id1).val());
    if (
      $("input[name='option']:checked").val() === "plus1" ||
      $("input[name='option']:checked").val() === "minus1"
    ) {
  ...
  render() {
    ...
    let id1 = `hideReason_${this.props.postId}`;
    const plus1UI = (
      <div className="column" id="award">
        <div className="column manageOperation">
          <div className="manageObject">
            <div className="judgeName">原因</div>
          </div>
          ...
          >
            <div className="row">
              ...
              >
                <option className="react-bootstrap-option" value="所言极是">
                  所言极是
                </option>
                <option className="react-bootstrap-option" value="非常求是">
                  非常求是
                </option>
                <option className="react-bootstrap-option" value="好人一生平安">
                  好人一生平安
                </option>
              ...
              <input
                id={id1}
                className="react-bootstrap-smalltext"
                style={{ display: "none" }}
              />
            </div>
            <div
          ...
          >
            <div className="row">
              <select
                ...
                className="react-bootstrap-select"
              >
                <option className="react-bootstrap-option" value="太不求是">
                  太不求是
                </option>
                <option className="react-bootstrap-option" value="呵呵">
                  呵呵
                </option>
                <option className="react-bootstrap-option" value="被你暴击">
                  被你暴击
                </option>
                <option className="react-bootstrap-option" value="自定义">
                  自定义
    ...
    const UIId = `judge${this.props.postId}`;
    return (
      <div style={{ display: "none" }} id={UIId} className="judgeManagement">
        ...
        <div
          className="row"
          style={{ justifyContent: "space-around", padding: "0 3rem" }}
        >
          <button
            style={{
              border: "none",
              backgroundColor: "#8bc9db",
              color: "white",
              textDecoration: "underline",
              fontSize: "1.25rem",
            }}
            onClick={this.confirm}
            className="confirmManagement"
          >
            确认
          </button>
          <button

    ...
    render() {
        ...
        const url = `/topic/${this.match.params.topicid}/user/${this.match.params.userId}/`;
            ...
            return <div className="center" style={{ width: "1140px" }} >
                ...
                {topic}
                <Reply topicInfo={this.state.topicInfo} DateTime={Date.now()} boardInfo={this.state.boardInfo} page={this.state.page} topicId={this.state.topicid} userId={this.state.userId} quote={this.quote} isTrace={true} isHot={false}  />
                <div style={{ width: "100%" }}>
                    <Pager page={this.state.page} totalPage={this.state.totalPage} url={url} /></div>

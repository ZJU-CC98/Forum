...
export class SearchBeforeConnent extends React.Component<{ history }, AppState> {     //搜索框组件
	...
	async componentDidMount() {
        ...
        let url1 = location.href.match(/\/topic\/([1-9]+)/);
        let url2 = location.href.match(/\/list\/([1-9]+)/);
		...
		return <div className="header">
			<div className="topBar">
				<div className="topBarRow">
					<div className="row"><div> <Link to="/"><img src="/static/images/cc98logo.ico" /></Link></div><div style={{ margin: '15px 0 0 5px' }}><Link to="/"><img src="/static/images/CC98.ico" /></Link></div></div>
					<DropDown />
				</div>
			</div>

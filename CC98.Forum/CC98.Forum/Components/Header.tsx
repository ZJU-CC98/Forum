        ...
        return <div className="header">
            <div className="topBar">
                <div className="topBarRow">
                    <div className="row"><div style={{ margin: '10px 0 0 0' }}> <Link to="/"><img src="/images/cc98logo.ico" /></Link></div><div style={{ margin: '15px 0 0 5px' }}><Link to="/"><img src="/images/CC98.ico" /></Link></div></div>
                    <DropDown />
                </div>
            </div>

        ...
        return <div className="footer">
            <div className="column">
                <div className="footerRow">
                    ...
                    <a href="http://www.xcb.zju.edu.cn">党委宣传部</a>|
                    <a href="http://www.cs.zju.edu.cn">计算机学院</a>|
                    <a href="http://www.nexushd.org">NexusHD高清社区</a>|
                    <a href="http://www.qsc.zju.edu.cn">求是潮</a>|
                    <a href="https://zjuers.com">ZJUers轻首页</a>
                </div>
                ...
                <div className="footerRow">
                    Copyright © 2003-{(new Date()).getFullYear()} CC98 Durian v3.3.0 | <a href="mailto:contact@cc98.org">Email: contact@cc98.org</a>
                </div>
            </div>
        </div>
    }

        ...
        <div className="announcement">
          <div className="mainPageTitle1">
            <div className="mainPageTitleRow" style={{ width: "100%" }}>
              ...
              <div style={{ flexGrow: 1 }} className="mainPageTitleText">
                全站公告
              </div>
...
> {
  ...
  convertButton(value: number, index: number, array: number[]) {
    const className: string = value
      ? "recommendedReadingButtonSelected"
      ...
      <div className="recommendedReading">
        ...
        <div className="recommendedReadingContent">
          ...
          <div className="column" style={{ flexGrow: 1 }}>
            <div className="recommendedReadingTitle">
 ...
 * 热门话题组件
 **/
export class HotTopicComponent extends React.Component<
  { data },
        ...
        <div className="mainPageTitle1">
          ...
          <div className="mainPageTitleRow">
            <div className="mainPageTitleText">
              <a href="/topic/hot-weekly" target="_blank">
                本周
              </a>
            </div>
            <div className="mainPageTitleText">
              <a href="/topic/hot-monthly" target="_blank">
                本月
              </a>
            </div>
            <div className="mainPageTitleText">
              <a href="/topic/hot-history" target="_blank">
                历史上的今天
              </a>
            </div>
          </div>
 ...
 **/
export class MainPageTopicComponent extends React.Component<
  {
    data;
    name: string;
    fetchUrl: string;
    style: string;
    mores: MainPageTopicMoreProps[];
  },
  {}
> {
...
> {
  convertRecommendedFunction(item: MainPageColumn) {
    return (
      <div className="recommendedFunctionRow">
        ...
        <div className="recommendedFunctionTitle">
          <a href={item.url} target="_blank">
            {item.title}
          </a>
        </div>
  ...
  render() {
    return (
      <div className="recommendedFunction">
        <div className="mainPageTitle1">
          <div className="mainPageTitleRow">
            <i className="fa fa-volume-up"></i>
 ...
 * 每20s切换一条
 */
export class AdsComponent extends React.Component<
  {},
  { ads: MainPageColumn[]; index: number }
> {
  private timer: any;
      ...
      <div className="mainPageCount">
        ...
        <div className="mainPageCountContent">
          ...
          <div className="mainPageCountRow">
            ...
            <div className="mainPageCountTitle">
              {data.todayTopicCount || 0}
            </div>
          </div>
          <div className="mainPageCountRow">
          ...
          <div className="mainPageCountRow">
            ...
            <div className="mainPageCountTitle">
              <Link to={`/user/name/${encodeURIComponent(data.lastUserName)}`}>
                {data.lastUserName}
              </Link>
            </div>
          </div>
...
export class MainPage extends React.Component<{}, { data }> {
  constructor(props) {
    //为组件定义构造方法，其中设置 this.state = 初始状态
  ...
  render() {
    ...
    let study: MainPageTopicMoreProps[] = new Array(
      { name: "学习", url: "/board/68" },
      { name: "外语", url: "/board/304" },
      { name: "考研", url: "/board/263" },
      { name: "出国", url: "/board/102" }
    );
    let emotion: MainPageTopicMoreProps[] = new Array(
      { name: "缘分", url: "/board/152" },
      { name: "小屋", url: "/board/114" },
      { name: "感性", url: "/board/81" }
    );
    ...
    let partTimeJob: MainPageTopicMoreProps[] = new Array({
      name: "更多",
      url: "/board/459",
    });

    let count: MainPageCountProps = new MainPageCountProps(
      data.todayCount,
      data.todayTopicCount,
      data.topicCount,
      data.postCount,
        ...
        <div className="leftPart">
          ...
          <div className="row" style={{ justifyContent: "space-between" }}>
            ...
            <MainPageTopicComponent
              data={data.schoolEvent}
              name="校园活动"
              fetchUrl="/topic/school-event"
              style="blue"
              mores={[]}
            />
          </div>
          ...
          <div className="row" style={{ justifyContent: "space-between" }}>
            <MainPageTopicComponent
              data={data.emotion}
              name="感性·情感"
              fetchUrl="/topic/emotion"
              style="blue"
              mores={emotion}
            />
            <MainPageTopicComponent
              data={data.fleaMarket}
              name="跳蚤市场"
              fetchUrl="/topic/flea-market"
              style="blue"
              mores={fleaMarket}
            />
          </div>
          <div className="row" style={{ justifyContent: "space-between" }}>
            <MainPageTopicComponent
              data={data.fullTimeJob}
              name="求职广场"
              fetchUrl="/topic/full-time-job"
              style="black"
              mores={fullTimeJob}
            />
            <MainPageTopicComponent
              data={data.partTimeJob}
              name="实习兼职"
              fetchUrl="/topic/part-time-job"
              style="black"
              mores={partTimeJob}
            />
          </div>

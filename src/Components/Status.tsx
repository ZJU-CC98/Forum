...
export const LogOut = () => (
  <div className="errorState">
    ...
    <div>
      <img className="errorIcon" src="/images/401.png" />
    </div>
...
export const TopicDeleted = () => (
  <div className="errorState">
    ...
    <div>
      <img className="errorIcon" src="/images/404.png" />
    </div>
    <div className="errorTitle">糟糕！好像出错了</div>
...
export const CannotPost = () => (
  <div className="errorState">
    ...
    <div>
      <img className="errorIcon" src="/images/403.png" />
    </div>
    <div className="errorTitle">糟糕！好像出错了</div>
...
export const ServerError = () => (
  <div className="errorState">
    ...
    <div>
      <img className="errorIcon" src="/images/500.png" />
    </div>
    <div className="errorTitle">糟糕！好像出错了</div>

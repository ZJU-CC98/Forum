...
export class UbbTagSegment extends UbbSegment {
   ...
   * @returns {UbbTagData} 
   */
  get getTagData() { return this._tagData };
...
export class UbbEmptyTagSegment extends UbbTagSegment {
  get type(): UbbSegmentType { return UbbSegmentType.EmptyTag };
   ...
   * 获取一个值，指示标签是否显式地配对。
   */
  get isExplicitlyPaired() { return this._isExplicitlyPaired };
   ...
   */
  constructor(tagData: UbbTagData, tagName: string, isExplicitlyPaired: boolean, parent: UbbTagSegment) {
  ...
  clone(newParent: UbbTagSegment): UbbSegment {
    return new UbbEmptyTagSegment(this.getTagData, this._tagName, this._isExplicitlyPaired, newParent);
  }
}
...
export class UbbTagData {
   ...
   */
  get originalString() { return this._originalString };
          ...
          switch (tagMode) {
            ...
            case UbbTagMode.Empty:
              ...
              if (content.startsWith(tagData.endTagString, tagMatchRegExp.lastIndex)) {
                ...
                const newEmptyTag = new UbbEmptyTagSegment(tagData, tagName, isExplicitlyPaired, parent);
